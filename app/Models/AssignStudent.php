...
class AssignStudent extends Model
{
    ...
    public function student_payment(){
        return $this->belongsTo(StudentPayment::class,'student_id','student_id');
    }
    ...
    public function discount(){
        return $this->belongsTo(DiscountStudent::class,'id','assign_student_id');// it means the assignstudent table, in the id connected to the assign_student_id of discountstudent table
    }
}
